...
export const AGENTS: AgentDef[] = [
  ...
  },
  {
    ...
    description: "Submit a new site address for DataSite Intelligence Go/No-Go scoring",
    intent: "site_evaluation",
    examples: [
      "Evaluate 3990 E Broad Street, Columbus OH 43213 for hyperscale compute",
      "Submit 500 Industrial Pkwy, Grove City OH for AI/HPC evaluation",
      "New site: 1200 Alum Creek Dr, Columbus OH — 150 acres, 100MW available",
      "Run a Go/No-Go on this parcel for data center development",
    ],
  },
  {
    id: "site-researcher",
    label: "Site Researcher",
    description: "Research utility availability, fiber, zoning, incentives, and market conditions for a site",
    intent: "site_research",
    examples: [
      "What fiber providers are near 3990 E Broad Street Columbus?",
      "Research utility capacity and incentives in Franklin County Ohio",
      "What's the permitting environment for data centers in Grove City?",
      "Check water availability for our Columbus site",
    ],
  },
  {
    id: "site-scorer",
    label: "Site Scorer",
    description: "Explain scores, compare site evaluations, or request a re-score",
    intent: "site_scoring",
    examples: [
      "Why did the Columbus site score low on fiber?",
      "Explain the power score for site ID abc123",
      "Compare our top two sites side by side",
      "Re-score the Grove City site with updated power data",
    ],
  },
  {
    id: "site-status",
    label: "Site Status",
    description: "Check the status and progress of site evaluations in the pipeline",
    intent: "site_status",
    examples: [
      "What's the status of the Columbus site evaluation?",
      "How many sites are in the scoring stage?",
      "Show me all sites with a strong recommend verdict",
      "Which sites are still in research?",
    ],
  },
];
