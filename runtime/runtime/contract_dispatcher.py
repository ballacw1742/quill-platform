...
class ContractDispatcher:
    ...
    # ------------------------------------------------------------------
    # State-store seam (Sprint 5.5). When ``self._store`` is set (Cloud Run
    # worker → Postgres), all dedupe/claim/success/error state routes there
    # with atomic multi-replica claim semantics. Otherwise the legacy
    # single-process JSON-file logic below is used, unchanged.
    # ------------------------------------------------------------------
